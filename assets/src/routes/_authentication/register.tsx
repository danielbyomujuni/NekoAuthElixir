...
export default function Register() {
  ...
  return (
    <>
      <div className="my-auto flex flex-col gap-4 h-full">
        <h1 className="text-3xl mb-3">Register</h1>
        <div className="grow flex flex-col justify-center gap-0">
          ...
          <div className="mt-4 text-center text-sm">
            ...
            <a href={`login?${new URLSearchParams(searchParams)}`} className="underline">
              Login
            </a>
          </div>
        </div>
